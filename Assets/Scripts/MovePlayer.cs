...
public class MovePlayer : MonoBehaviour
{
    ...
    private Vector2 m_RotateAxis;          // 회전을 저장할 수 
    private float m_FixRotateX;            // 기존 카메라가 갖고있는 X 각도
    ...
    private void UpdateMove()
    {
        ...
        // 말 그대로 캐릭터를 컨트롤 하는 녀석인데, transform 을 직접적으러 조종하는 것이 아니라
        ...
        // transfor.TransformDirection(Vector3);
        // 로컬 ? 내 자기 자신의 공간
        // 월드 ? 부모를 포함한 공간
